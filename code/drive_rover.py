...
class RoverState():
    def __init__(self):
        ...
        self.n_pix_front_x = None # Number of pix front corridor
        self.n_pix_front_y = None # Number of pix front corridor
        ...
        self.stop_forward = 160 # Threshold to initiate stopping
        self.stop_left_corr = 6  # Threshold for corridor left side 
        self.stop_right_corr = -6 # Threshold for corridor right side
